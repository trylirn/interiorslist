...
const PROVIDER_COLS =
  "place_id, slug, name, city, city_slug, address, website, specialists, credentials, notes, branch_label, is_verified, badges, services, styles, services_raw, about_description, social_links, gallery_urls, video_urls, certificate_urls, hero_photo_url, rating, review_count";

...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Discover Medspa — Trusted Aesthetic Injector Directory" },
      ...
      { property: "og:title", content: "Discover Medspa — Trusted Aesthetic Injector Directory" },
      ...
      { property: "og:site_name", content: "Discover Medspa" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Discover Medspa — Trusted Aesthetic Injector Directory" },

...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Intearior — Trusted Interior Design Studio Directory" },
      ...
      { property: "og:title", content: "Intearior — Trusted Interior Design Studio Directory" },
      ...
      { property: "og:site_name", content: "Intearior" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Intearior — Trusted Interior Design Studio Directory" },

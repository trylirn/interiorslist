...
export const Route = createFileRoute("/_site/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Service | Discover Medspa" },
      { name: "description", content: "Terms governing use of Discover Medspa, including HIPAA notice, arbitration, and medical disclaimers." },
      { name: "robots", content: "index, follow" },
      { property: "og:title", content: "Terms of Service — Discover Medspa" },
      { property: "og:description", content: "Terms, disclaimers, HIPAA notice, and dispute resolution." },
  ...
  return (
    <article className="mx-auto max-w-3xl px-4 py-16">
      ...
      <Section title="1. Agreement to these Terms">
        These Terms of Service ("Terms") form a binding agreement between you and Discover Medspa ("Discover Medspa", "we", "us", or "our") governing your access to and use of the texas-beauty-glow.lovable.app website and any related services, features, and content (collectively, the "Site"). By accessing or using the Site — including by browsing, searching, creating an account, submitting a claim or business listing, posting a review, or contacting a provider through the Site — you agree to be bound by these Terms and by our <Link to="/privacy" className="text-brand underline">Privacy Policy</Link>, which is incorporated by reference. If you do not agree, do not use the Site.
      </Section>

      <Section title="2. Eligibility">
        You must be at least 18 years old and legally able to form a binding contract to use the Site. The Site is intended for use by residents of the United States, primarily Texas. If you use the Site from outside the U.S., you are responsible for compliance with any local laws that apply to you.
      </Section>

      <Section title="3. Nature of the service — informational directory only">
        Discover Medspa is a consumer-facing informational directory that lists Texas-based medical spas, aesthetic clinics, and injectors. We are not a healthcare provider, medical practice, clinic, insurance plan, pharmacy, or laboratory. We do not:
        <ul className="mt-2 list-disc pl-5 space-y-1">
          <li>diagnose, treat, prescribe, or provide any medical service;</li>
          <li>form a doctor–patient, nurse–patient, or clinician–patient relationship with you;</li>
          <li>refer you to any specific provider, or receive compensation for individual referrals;</li>
          <li>guarantee the qualifications, licensure, safety, availability, pricing, or outcomes of any listed provider.</li>
        </ul>
      ...
      <Section title="4. Medical disclaimer and no advice">
        The content on the Site — including treatment guides, editorial articles, provider descriptions, FAQs, service listings, and any information linked from provider websites — is for general informational purposes only. It is <strong>not medical advice, diagnosis, or treatment</strong>. Always consult a qualified, Texas-licensed healthcare professional before undergoing any cosmetic or aesthetic procedure. In an emergency, call 911.
      </Section>

      <Section title="5. HIPAA notice">
        Discover Medspa is <strong>not a Covered Entity or Business Associate</strong> under the Health Insurance Portability and Accountability Act ("HIPAA"). We do not collect, store, or process protected health information ("PHI") in the HIPAA-regulated sense. You agree <strong>not to submit</strong> PHI or any sensitive health information through the Site, including in reviews, contact forms, submission forms, claim forms, or messages to providers. If you voluntarily transmit health-related information through the Site, you acknowledge and agree that (a) such information is not protected by HIPAA when in our possession, (b) we may store, display, forward to the applicable provider, or delete such information consistent with these Terms and our Privacy Policy, and (c) you release us from any claim arising out of your voluntary disclosure. If you need to communicate PHI to a healthcare provider, do so directly through that provider's HIPAA-compliant channels — not through the Site.
      </Section>
      ...
      <Section title="7. Acceptable use">
        ...
        <ul className="mt-2 list-disc pl-5 space-y-1">
          ...
          <li>use the Site to send unsolicited communications to providers or other users;</li>
      ...
      <Section title="8. User content and reviews">
        You retain ownership of any content you submit (reviews, photos, submissions, claim materials, messages) ("User Content"). By submitting User Content, you grant Discover Medspa a worldwide, non-exclusive, royalty-free, perpetual, irrevocable, sublicensable license to host, store, reproduce, modify (for formatting), publish, display, and distribute the User Content in connection with operating and promoting the Site. You represent and warrant that (a) you own or control all rights to the User Content, (b) it is accurate and not misleading, (c) it does not contain PHI you were prohibited from submitting under Section 5, and (d) it does not violate these Terms or any law.<br /><br />
      ...
      <Section title="9. Provider listings, claims, and accuracy">
        Business listings — names, addresses, websites, contact details, service descriptions, articles, and hours — are compiled from publicly available information about Texas-licensed medspas and aesthetic clinics, from information provided by owners who claim their listing, and from third-party sources such as public web content ingested via automated tools. Information may be incomplete, outdated, or contain errors. If you are a business owner or authorized representative, you may claim or update your listing via our <Link to="/claim/$slug" params={{ slug: "your-listing" }} className="text-brand underline">claim flow</Link>, our <Link to="/submit" className="text-brand underline">submission form</Link>, or by contacting us. We may approve, reject, edit, delist, or remove any listing or claim at our sole discretion.
      </Section>

      <Section title="10. Third-party sites, off-platform bookings, and provider communications">
        The Site links to third-party websites and services, and enables you to contact providers directly. Once you leave the Site or communicate with a provider (whether through our contact form or a link to the provider's website, phone, or booking system), any subsequent interaction — including consultations, appointments, payments, medical care, and disputes — is solely between you and that provider. We are not a party to that relationship. We are not responsible for provider availability, pricing, treatment, safety, refund policies, or the content and privacy practices of any third-party site.
      </Section>

      <Section title="11. Intellectual property">
        The Site, including its design, code, editorial content, aggregated data, trademarks, and logos, is owned by Discover Medspa or its licensors and protected by U.S. and international intellectual-property laws. Provider names, brands, and logos are the property of their respective owners and are used for identification purposes only. Except for the limited license to use the Site for personal, non-commercial purposes, we grant you no rights in our intellectual property.
      </Section>
      ...
      <Section title="13. Disclaimers of warranties">
        THE SITE, INCLUDING ALL CONTENT, LISTINGS, USER CONTENT, ARTICLES, AND FEATURES, IS PROVIDED "AS IS" AND "AS AVAILABLE" WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, NON-INFRINGEMENT, ACCURACY, AND UNINTERRUPTED OR ERROR-FREE OPERATION. WE DO NOT WARRANT THE QUALIFICATIONS, LICENSING, SAFETY, PRICING, AVAILABILITY, OR RESULTS OF ANY LISTED PROVIDER. NO ADVICE OR INFORMATION OBTAINED FROM THE SITE CREATES ANY WARRANTY NOT EXPRESSLY STATED HERE.
      </Section>

      <Section title="14. Limitation of liability">
        TO THE FULLEST EXTENT PERMITTED BY LAW, TEXAS AESTHETICS AND ITS OFFICERS, EMPLOYEES, AGENTS, AND LICENSORS WILL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS, REVENUE, DATA, GOODWILL, OR OTHER INTANGIBLE LOSSES, ARISING OUT OF OR RELATING TO YOUR USE OF THE SITE, ANY LISTED PROVIDER, ANY USER CONTENT, OR THESE TERMS, EVEN IF ADVISED OF THE POSSIBILITY OF SUCH DAMAGES. OUR AGGREGATE LIABILITY FOR ANY CLAIM ARISING OUT OF OR RELATING TO THE SITE WILL NOT EXCEED THE GREATER OF (A) ONE HUNDRED U.S. DOLLARS ($100) OR (B) THE AMOUNTS YOU PAID US IN THE TWELVE MONTHS BEFORE THE EVENT GIVING RISE TO THE CLAIM. SOME JURISDICTIONS DO NOT ALLOW CERTAIN LIMITATIONS; IN THOSE JURISDICTIONS OUR LIABILITY IS LIMITED TO THE MAXIMUM EXTENT PERMITTED.
      </Section>

      <Section title="15. Indemnification">
        You will indemnify, defend, and hold harmless Discover Medspa and its officers, employees, and agents from and against any claims, damages, liabilities, and reasonable expenses (including attorneys' fees) arising out of or related to (a) your User Content, (b) your use of the Site, (c) your interactions with any provider, (d) your violation of these Terms or any law, or (e) your violation of any third-party right.
      </Section>
      ...
      <Section title="17. Governing law">
        These Terms are governed by the laws of the State of Texas, without regard to conflict-of-laws principles. Subject to Section 18, any dispute not subject to arbitration will be brought exclusively in the state or federal courts located in Travis County, Texas, and you consent to personal jurisdiction and venue there.
      </Section>

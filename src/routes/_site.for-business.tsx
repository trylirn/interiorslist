      ...
      <section className="relative border-b border-border/60">
        ...
        <div className="relative mx-auto max-w-5xl px-4 py-20 text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Button asChild size="lg" className="rounded-full"><Link to="/login" search={{ tab: "business" }}>Submit your business</Link></Button>
      ...
      <section className="mx-auto max-w-3xl px-4 py-20">
        ...
        <div className="mt-12 rounded-3xl bg-brand p-10 text-center text-brand-foreground">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-3">
            <Button asChild size="lg" variant="secondary" className="rounded-full"><Link to="/login" search={{ tab: "business" }}>Submit your business</Link></Button>
